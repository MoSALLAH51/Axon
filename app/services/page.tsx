...
const T = {
  en: {
    ...
    heroDesc:          "Comprehensive landscape architecture, design, and nursery services for every scale of project across the area.",
  ...
  ar: {
    ...
    badge:             "ما نقدمه",
    heroTitle:         "خدماتنا",
    heroDesc:          "خدمات شاملة في هندسة المناظر الطبيعية والتصميم والمشتل لكل حجم من المشاريع في المنطقة.",
