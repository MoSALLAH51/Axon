...
export default function HomePage({ services, projects }: HomePageClientProps){
...
/**
 * Company Profile — a sprouting seedling / plant, representing growth
 * and the living nature of the landscape business.
 */
...
/**
 * License — a shield with a checkmark, conveying official approval,
 * compliance, and trust — fitting for regulatory licenses in the UAE.
 */
  ...
  return (
    <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
      ...
      <path
        ...
        d="M12 3l7.5 3v5c0 4.5-3.5 8-7.5 9.5C8 19 4.5 15.5 4.5 11V6L12 3Z"
      />
...
/**
 * Certificate — a rosette / award ribbon, the universally recognised
 * symbol for quality certifications and accreditations.
 */
